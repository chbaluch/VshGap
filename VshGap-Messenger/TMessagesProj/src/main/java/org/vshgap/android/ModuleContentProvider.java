...
public class ModuleContentProvider extends ContentProvider {
    ...
    private static final String AUTHORITY = "org.vshgap.android.provider.content";
    private static final String AUTHORITY_BETA = "org.vshgap.android.provider.content";
