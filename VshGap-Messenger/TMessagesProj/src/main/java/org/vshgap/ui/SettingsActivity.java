...
import org.vshgap.messenger.BuildVars;
    ...
    private class ListAdapter extends BaseFragmentAdapter {
        ...
        public boolean isEnabled(int i) {
            return i == textSizeRow || i == enableAnimationsRow || i == notificationRow || i == backgroundRow || i == numberRow || i == showAndroidEmojiRow ||
                    ...
                    i == switchBackendButtonRow || i == vshgapFaqRow || i == contactsSortRow || i == contactsReimportRow || i == saveToGalleryRow || i == keepOriginalFilenameRow;
        }
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (type == 0) {
                ...
                if (i == textSizeRow) {
                    ...
                    textCell.setText(LocaleController.getString("VshGapFAQ", R.string.VshGapFaq), true);
                } else if (i == contactsReimportRow) {
                ...
                if (view == null) {
                    ...
                    try {
                        ...
                        ((TextInfoCell) view).setText(String.format(Locale.US, "VshGap for Android v%s (%d)", pInfo.versionName, pInfo.versionCode));
                    } catch (Exception e) {
                        FileLog.e("tmessages", e);
                    }
                }
        ...
        public int getItemViewType(int i) {
            if (i == emptyRow || i == overscrollRow) {
                ...
                return 3;
            } else if (i == notificationRow || i == backgroundRow || i == sendLogsRow || i == privacyRow || i == clearLogsRow || i == switchBackendButtonRow || i == vshgapFaqRow || i == contactsReimportRow || i == textSizeRow || i == contactsSortRow) {
                return 2;
